...
export const cartierProducts: ShowcaseProduct[] = [
  {
    ...
    swatch: "#4a90e2",
    desc: "Lunettes de soleil Cartier rimless d'exception avec verres taillés cristal diamant faits main. Branches dorées premium d'une qualité et élégance remarquables.",
